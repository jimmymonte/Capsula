...
@Component({
  selector: 'app-melhores-momentos-grupo',
  templateUrl: './melhores-momentos-grupo.component.html',
  styleUrls: ['./melhores-momentos-grupo.component.css']
})
export class MelhoresMomentosGrupoComponent implements OnInit {
